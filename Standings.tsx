...
/** League table: each seller's latest known reputation/price/score, derived from the round feed
 * (the numbers themselves come straight from the buyer's own scoring — this just tracks the latest). */
